...
\section{Velocity maps, RT plots and trace profiles}
\label{composites}
Here we present a montage of plots for the CPSB and CPSB control galaxy samples. The stellar velocity map, the Radon transform plot and trace profiles are displayed across a row for each galaxy. All plots were calculated with RT input parameters of SNCUT = 1, MC\_ITER = 250 and aperture scale factor = 1.0 (i.e. $R_{ap}=1.0*B/A*R_{eff}$).
Figures ... show ... [TODO]

\begin{figure*}
    \centering
    \includegraphics[width=0.92\textwidth]{Images/SN1-MC250/CPSB-triples/CPSB-7964-1902-1-250.png}
    \includegraphics[width=0.92\textwidth]{Images/SN1-MC250/CPSB-triples/CPSB-8080-3702-1-250.png}
    \includegraphics[width=0.92\textwidth]{Images/SN1-MC250/CPSB-triples/CPSB-8081-3702-1-250.png}
    \includegraphics[width=0.92\textwidth]{Images/SN1-MC250/CPSB-triples/CPSB-8082-3704-1-250.png}    
    \caption{Radon transform output graphics for CPSBs (set 1 of 6). Displayed on each row, from left to right, are the MaNGA stellar velocity map, the Radon transform RT plot and the RT trace profile. The MaNGA plate-ifu ID is displayed above each subplot.}
